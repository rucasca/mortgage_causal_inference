...
Como resultado tenemos que la probabilidad de no conceder el prestamo una vez emparejado el dataset es aun mayor en el caso de que 
 
Cabe destacar que solo estamos teniendo en cuenta el efecto a nivel global, sin realizar distinciones entre posibles grupos donde los efectos sean heterogéneos. Además, 
